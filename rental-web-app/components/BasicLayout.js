...
function BasicLayout({ children }) {
	...
	return (
		<Layout style={{ minHeight: '100vh' }}>
			<Header className="header" style={{ backgroundColor: 'blue', maxHeight: 50 }}>
				<Row>
					<Col span={17}>
						<div className="logo" style={{ float: 'left' }}>
							<Title level={4} style={{ color: 'white', marginTop: 10, fontWeight: 300 }}>Microfinance - Car Rental UI</Title>
						</div>
					</Col>
					<Col span={4}>
