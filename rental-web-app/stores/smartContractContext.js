...
import CarRentalBuild from '../../blockchain/build/contracts/ABCRental.json'
...
export const SmartContractContextProvider = ({ children }) => {
	...
	const context = { web3, MicroTokenContract, UserIdentityContract, BankLoanContract, CarRentalContract };
